        ...
        >
          ...
          <div class="productDetail">
            ...
            <div class="fixArea">
              ...
              <!-- floatMenu -->
              <aside class="floatMenu" ref="flottingMenu">
                <div class="floatScroll">
                  ...
                  <p class="price" v-if="product">
                    <span>₩ {{ formatPrice(getOriginPrice(product.price, product.discountPer)) }}원</span>
...
const { items, getItems } = storeToRefs(bucketStore);
...
const addBuckets = () => {
  ...
  if (info) {
    ...
    bucketItems.imgUrl = <string>product?.value?.images[0];
...
.loading img {opacity: 0;   transition: all 0.6s ease-in-out;
}
.contents:not(.loading) img {opacity: 1;   transition: all 0.6s ease-in-out;
}
.v-enter-active,
.v-leave-active {
