<template>
    <div id="container" @scroll="scrolling">
        <div class="contents">
            <!-- conTopArea -->
            ...
            <div class="productDetail">
                ...
                <div class="fixArea">
                    ...
                    <!-- floatMenu -->
                    <div class="floatMenu" ref="flottingMenu" >
...
const scrolling = (e: Event) => {
  ...
  console.log('flottingMenu',flottingMenu.value?.offsetTop, flottingMenu.value?.clientTop,e)
}
onMounted(() => {
...
<style lang="scss">
.floatScroll {position: absolute; left: 0; right: 0; top:0; bottom: 0; overflow-y: scroll; overflow-x: hidden;
  background: #fff;
